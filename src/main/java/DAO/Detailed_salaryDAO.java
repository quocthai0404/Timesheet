...
public class Detailed_salaryDAO {
    public List<Detailed_salary> selectDetailedSalaries() {
        ...
        try {
            ...
            while (rs.next()) {
                list.add(new Detailed_salary(
                        rs.getInt("detailed_salary_id"),
                        rs.getInt("employee_id"),
                        rs.getDouble("base_salary"),
                        rs.getDouble("paid_leave_pay"),
                        rs.getDouble("allowance"),
                        rs.getInt("number_of_paid_leave_days"),
                        rs.getInt("number_of_unpaid_leave_days"),
                        rs.getDouble("number_of_overtime_hours"),
                        rs.getDouble("unpaid_leave_deduction"),
