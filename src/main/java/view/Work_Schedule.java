...
public class Work_Schedule extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        textFieldWork_Shift = new JTextField();
        textFieldWork_Shift.setFont(new Font("Calibri", Font.BOLD, 14));
        textFieldWork_Shift.setBounds(609, 235, 180, 30);
        getContentPane().add(textFieldWork_Shift);
    ...
    private JTextField textFieldWork_Shift;
